...
cp storm_trooper.txt .tattooine
# Move `luke.txt` and `obi_wan.txt` to the `millenium_falcon`
mv luke.txt/millenium_falcon mv obi_wan.txt/mil
...
cd~/Desktop/galaxy_far_far_away mkdir yavin_4
# Move the `millenium_falcon` out of the `death_star` and into `yavin_4`
mv millenium_falcom ./yavin_4
# Make a directory in `yavin_4` called `x_wing`
cd~/Desktop/galaxy_far_far_away/yavin_4 mkdir x_wing
# Move `princess_leia.txt` to `yavin_4` and `luke.txt` to `x_wing`
mv pricess_leia.txt ./yavin_4 mv luke.txt ./x_wing
# Move the `millenium_falcon` and `x_wing` out of `yavin_4` and into `galaxy_far_far_away`
mv millenium_falcon/galaxy_far_far_away mv x_wing/galaxy_far_far_away
# In `death_star`, create directories for `tie_fighter_1`, `tie_fighter_2` and `tie_fighter_3`
cd~Desktop/galaxy_far_far_away/death_star mkdir tie_fighter_1 mkdir tie_figther_2 mkdir tie_fighter_3
# Move `darth_vader.txt` into `tie_fighter_1`
mv darth_vader ./tie_fighter_1
# Make a copy of `storm_trooper.txt` in both `tie_fighter_2` and `tie_fighter_3`
cp storm_trooper.txt ./tie_fighter_2 cp storm_trooper ./tie_fighter_3
# Move all of the `tie_fighters` out of the `death_star` and into `galaxy_far_far_away`
mv tie_fighter_1/galaxy_far_far_away mv tie_fighter_2/galaxy_far_far_away mv tie_fighter_3/galaxy_far_far_away
...
// Remove tie_fighter_3 Remove tie_fighter_3
# Touch a file in "**x_wing**" called "**the_force.txt**".
cd~/Desktop/galaxy_far_far_away/x_wing touch the force.txt
